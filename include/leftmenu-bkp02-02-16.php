<div id="middle">
       ...
       switch($_SESSION['ParentId'])
        ...
        <ul class="nav">
            ...
            <li><a class="home" href="http://trackingexperts.com/service/servicecalling/services.php">Running Services(<? echo getcountRow("SELECT * FROM services where (service_status='1'  or  service_status='2' or service_status='11')   and service_status!='5' and  service_status!='6' and req_date>'".$fromdateof_service."' and branch_id=".$_SESSION['BranchId'] ."  and request_by='".$_SESSION['username']."'");?>)</a></li>
           
            <li><a href="http://trackingexperts.com/service/servicecalling/back_installation.php">Back to installation<? $sql_pending=mysql_query("SELECT COUNT(*) FROM installation   WHERE  installation_status='3' and branch_id=".$_SESSION['BranchId'] ."  and request_by='".$_SESSION['username']."'");
           
            $row_pending=mysql_fetch_array($sql_pending);?>(<?=$row_pending[0]?>)</a></li>
           
            <li><a href="http://trackingexperts.com/service/servicecalling/running_installation.php">Running Installation(<? echo getcountRow("SELECT * FROM installation where installation_status IN ('1','2','11') AND (inter_branch='".$_SESSION['BranchId']."' OR branch_id='".$_SESSION['BranchId']."') and request_by='".$_SESSION['username']."'");?>)</a></li>
           
            <!--<li><a  href="add_installation.php">Add installation</a></li> and time>'".$fromdateof_service."'-->
            <li><a href="http://trackingexperts.com/service/servicecalling/installation.php"> Installation Request(<? echo getcountRow("SELECT * FROM installation_request where (installation_status='1' or installation_status='2'  or installation_status='4' or installation_status='7' or installation_status='8' or installation_status='9') and branch_id=".$_SESSION['BranchId']."  and request_by='".$_SESSION['username']."'");?>)</a></li>
        ...
        <ul class="nav">
          ...
          <h3>Cients Details</h3>
            <ul class="nav">
             <? if($_SESSION['BranchId']==1) {?>
                <li><a href="http://trackingexperts.com/service/servicecalling/list_company_clients.php" >Calling Client</a></li>
              <?php }?>
                <li><a href="http://trackingexperts.com/service/servicecalling/list_clients_details.php" >Client Details</a></li>
           
             </ul>
            <?php if($_SESSION['BranchId']==1){?> 
            <h3>Request</h3>
                <ul class="nav">
                    <li><a href="http://trackingexperts.com/service/servicecalling/list_delete_vehicle.php">Delete Vehicle(<?echo getcountRow("SELECT * FROM deletion where ((approve_status=0 or approve_status=1) and final_status!=1) and (service_comment is null or delete_veh_status=2) and (acc_manager='".$_SESSION['username']."' or (forward_req_user='".$_SESSION["username"]."' and (forward_back_comment is null or forward_back_comment='')))");?>)</a></li>
                </ul>
   <?php } ?>
           <?php if($_SESSION['BranchId']==1 && $_SESSION['isadmin']!=""){?>
            <h3>Login Report</h3>
                <ul class="nav">
...
<?       break;
       ...
       case '3':
        ...
        <ul class="nav">
            ...
            <ul class="nav">
               <!-- <li ><a class="home"  href="http://trackingexperts.com/service/support/service.php">Service </a></li>
                ...
                <li ><a class="home"  href=  "http://trackingexperts.com/service/support/installer_report.php">Installer Job Report</a></li>
           ...
           <?php if($_SESSION['username']=="pallavi"){?>    
                <li><a class="home" href="http://trackingexperts.com/service/support/all_branch_ser_inst.php">Service & Installation </a></li>
            <?php } else {?>  
                <li><a class="home" href="http://trackingexperts.com/service/support/service_installation_details.php">Service & Installation </a></li>
             <?php } ?>
           ...
           <h3>Reports</h3>
            <ul class="nav">
                ...
                <li><a class="home" href="http://trackingexperts.com/service/serviceprovider/list_installer.php">Add Installer  </a></li> 
                ...
                <?php } if($_SESSION['username']=="pallavi"){?>
                 <li><a class="home" href="http://trackingexperts.com/service/support/manufacture_replace_device.php">Manufacture Replace</a></li>
                <?php } if($_SESSION['username']=="ruchi" || $_SESSION['username']=="pallavi"){ ?>
                <li><a class="home" href="http://trackingexperts.com/service/support/list_client_sse_veh_details.php">Client Vehicle and SSE Details</a></li>
                <?php } ?>
            </ul>
        ...
        <?php if($_SESSION['username']=="ruchi" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){?> 
                ...
                <li ><a  class="home" href="http://trackingexperts.com/service/support/service_ffc_case.php">Temporary FFC</a></li>
        <?php }
           
            if($_SESSION['username']=="pallavi"){ ?>    
              
                <li ><a  class="home" href="http://trackingexperts.com/service/support/ffc_device_report.php">Permanent FFC </a></li>
               
       <?php } if($_SESSION['username']=="pallavi" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){?>

                <li ><a  class="home" href="http://trackingexperts.com/service/support/replace_ffc_device.php">Replace FFC</a></li>
                <li ><a  class="home" href="http://trackingexperts.com/service/support/new_ffc_device.php">New FFC</a></li>
       ...
       <?php if($_SESSION['username']=="pallavi"){?>
        ...
        <?php if($_SESSION['username']=="pallavi" || $_SESSION['username']=="ruchi" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){?>        
            ...
            <ul class="nav">
                ...
                <li><a href="http://trackingexperts.com/service/support/list_transfer_the_vehicle.php">Transfer Vehicle</a></li>
           
            </ul>
        <?php } if($_SESSION['username']=="pallavi" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){?>      
			<h3> Billing Details</h3>
			<ul class="nav">
			  <li ><a  class="home" href="http://trackingexperts.com/service/support/list_billing_file.php">Billing File Download</a></li>
			 
			</ul>

            <h3>Admin Forwarded</h3>
            <ul class="nav">
                <li><a href="http://trackingexperts.com/service/support/deact_of_acc_admin_req.php" >Deactivation Of Account(<?echo getcountRow("SELECT * FROM deactivation_of_account  where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/admin_for_request.php" >Delete From Debtors(<?echo getcountRow("SELECT * FROM del_form_debtors where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li> 
                                 
                <li><a href="http://trackingexperts.com/service/support/device_change_admin_req.php" >Device Change(<?echo getcountRow("SELECT * FROM device_change where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/new_device_addition_admin_req.php" >New Device Addition(<?echo getcountRow("SELECT * FROM new_device_addition where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/veh_no_change_admin_req.php" >Vehicle Number Change(<?echo getcountRow("SELECT * FROM vehicle_no_change where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/delete_vehicle_admin_req.php" >Delete Vehicle(<?echo getcountRow("SELECT * FROM deletion where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/deactivate_sim_admin_req.php" >Deactivate Sim(<?echo getcountRow("SELECT * FROM deactivate_sim where approve_status=1  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
 
                <li><a href="http://trackingexperts.com/service/support/discounting_details_fwd_req.php" >Discounting(<?echo getcountRow("SELECT * FROM discount_details where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/accountcreation_admin_req.php" >New Account Creation(<?echo getcountRow("SELECT * FROM new_account_creation where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/stop_gps_admin_req.php" >Stop GPS(<?echo getcountRow("SELECT * FROM stop_gps where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/transfer_the_vehicle_admin_req.php" >Transfer Vehicle(<?echo getcountRow("SELECT * FROM transfer_the_vehicle where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
               
                <li><a href="http://trackingexperts.com/service/support/list_start_gps_fwd_req.php" >Start GPS(<?echo getcountRow("SELECT * FROM start_gps where approve_status=0  and (forward_back_comment is null or forward_back_comment='') and forward_req_user='".$_SESSION["username"]."'");?>)</a></li>
            ...
            <?php
                ...
                elseif($_SESSION['username']=="ragini"){$request = "('sanjeeb','mumbai')";}
            ...
            if($_SESSION['username']=="pallavi" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){
                ?>
                <li><a href="http://trackingexperts.com/service/support/list_deactivate_of_account.php">Deactivation Of Account(<?echo getcountRow("SELECT * FROM deactivation_of_account where approve_status=0 and service_comment is null and acc_manager in ".$request);?>)</a></li>
               
               <!-- <li><a href="http://trackingexperts.com/service/support/list_deletion_from_debtors.php">Delete From Debtors(<?echo getcountRow("SELECT * FROM del_form_debtors where approve_status=0 and service_comment is null and acc_manager in ".$request);?>)</a></li> -->
               
                <li><a href="http://trackingexperts.com/service/support/list_no_bill.php">No Bill(<?echo getcountRow("SELECT * FROM no_bills where (approve_status=0 and no_bill_issue in ('Service Issue','Client Side Issue') and service_comment is null and acc_manager in ".$request.") or (forward_req_user='".$_SESSION["username"]."' and (forward_back_comment is null or forward_back_comment=''))");?>)</a></li>
             <?php } ?>  
                <li><a href="http://trackingexperts.com/service/support/list_discounting.php">Discounting(<?echo getcountRow("SELECT * FROM discount_details where discount_issue='Service Issue' and (approve_status=0 or approve_status=2) and service_comment is null and acc_manager in ".$request);?>)</a></li> 
       ...
       case '2':
        ...
        <?php } ?>
           ...
           {*/?>
                ...
                <li> <a   href="http://trackingexperts.com/service/serviceprovider/newservice.php"> Open Services
    <? $sql_status="SELECT COUNT(*) FROM services WHERE service_status='1' and ((inter_branch=0 and branch_id='".$_SESSION['BranchId']."') or (inter_branch='".$_SESSION['BranchId']."' and branch_id!='".$_SESSION['BranchId']."'))";
                ...
                <li> <a   href="http://trackingexperts.com/service/serviceprovider/new_installation.php">Open Installtion
    <? $sql_status="SELECT COUNT(*) FROM installation WHERE installation_status='1' and ((inter_branch=0 and branch_id='".$_SESSION['BranchId']."') or (inter_branch='".$_SESSION['BranchId']."' and branch_id!='".$_SESSION['BranchId']."'))";
                $result_status=mysql_query($sql_status);
                $row_service=mysql_fetch_array($result_status);?>(<?=$row_service[0]?>)</a></li>
