        ...
        <h3>Service Calling</h3>
            <ul class="nav">
               <li><a   href="<?php echo __SITE_URL;?>/servicecalling/pendingservice.php">Back to Service(<? echo getcountRow("SELECT * FROM services WHERE  service_status='3' and branch_id=".$_SESSION['BranchId'] ."  and request_by='".$_SESSION['username']."'");?>)</a></li>
                ...
                <li><a class="home" href="<?php echo __SITE_URL;?>/servicecalling/services.php">Running Services(<? echo getcountRow("SELECT * FROM services where (service_status='1'  or  service_status='2' or service_status='11' or service_status='17' or service_status='18')   and service_status!='5' and  service_status!='6' and req_date>'".$fromdateof_service."' and branch_id=".$_SESSION['BranchId'] ."  and request_by='".$_SESSION['username']."'");?>)</a></li>
                ...
                <li><a href="<?php echo __SITE_URL;?>/servicecalling/running_installation.php">Running Installation(<? echo getcountRow("SELECT * FROM installation where installation_status IN ('1','2','11','17','18') AND (inter_branch='".$_SESSION['BranchId']."' OR branch_id='".$_SESSION['BranchId']."') and request_by='".$_SESSION['username']."'");?>)</a></li>
          ...
          <h3>Cients Details</h3>
            ...
            <ul class="nav">
             ...
             <? if($_SESSION['BranchId']==1) {?>
                ...
                <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_add_clients.php" >Client Extension</a></li>
        ...
        <?php if($_SESSION['BranchId']==1){?>
            ...
            <h3>Request</h3>
                <ul class="nav">
                    ...
                    <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_new_device_addition.php">New Device Addition</a></li>
                    
                    <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_device_change.php">Device Change</a></li>
                    
                    <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_vehicle_no_change.php">Vehicle Number Change</a></li>
                    
                    <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_sim_change.php">Sim Change</a></li>
                    
                    <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_transfer_the_vehicle.php">Transfer Vehicle</a></li>
        ...
        ?>  
         <h3>Cients Details</h3>
            ...
            <ul class="nav">
                ...
                <li><a href="<?php echo __SITE_URL;?>/servicecalling/list_add_clients_view.php" >Client Extension</a></li>
   ...
   break;
       ...
       switch($_SESSION['ParentId'])
       {
        ...
        <ul class="nav">
            ...
            <li><a href="<?php echo __SITE_URL;?>/support/billing.php" target="_blank">Billing</a></li>
        ...
        <h3>Service & Support</h3>
           ...
           <h3>Reports</h3>
            ...
            <ul class="nav">
                ...
                <?php if($_SESSION['username']=="dservicehead" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){?>
               ...
               <li><a class="home" href="<?php echo __SITE_URL;?>/support/client_profile.php">Client Report</a></li>
               <?php } ?>
       ...
       <?php if($_SESSION['username']=="dservicehead"){?>
         ...
         if($_SESSION['username']=="dservicehead" || $_SESSION['username']=="ragini" || $_SESSION['username']=="rajeshree" || $_SESSION['username']=="jaipursupport"){?>
         ...
         <h3>Service Request</h3>
            ...
            <ul class="nav">
             ...
             <!--     <li><a href="<?php echo __SITE_URL;?>/support/list_device_change_new.php">Device Change(<? echo getcountRow("SELECT * FROM device_change  where approve_status=0 and (service_support_com is null or device_change_status=2)  and (account_comment!='' or pay_status!='') and rdd_device_type='New' and billing='Advance'");?>)</a></li> -->
                ...
                <li><a href="<?php echo __SITE_URL;?>/support/list_device_change_new.php">Device Change(<? echo getcountRow("SELECT * FROM device_change  where approve_status=0 and final_status!=1 and (service_support_com is null or device_change_status=2)  and (account_comment!='' or pay_status!='') and rdd_device_type='New'");?>)</a></li>
       ...
       case '2':
        ...
        <?php } ?>
           ...
           {*/?>
                ...
                <li><a   href="<?php echo __SITE_URL;?>/serviceprovider/service.php">Running Services(<? echo getcountRow("SELECT * FROM services  where service_status IN ('2','17','18') and (branch_id='".$_SESSION['BranchId']."' or inter_branch='".$_SESSION['BranchId']."')");?>)</a></li>

                <li><a   href="<?php echo __SITE_URL;?>/serviceprovider/forward_to_repair.php">Service Forward to Repair(<? echo getcountRow("SELECT * FROM services  where (service_status='11' and ((fwd_tech_rm_id is NOT NULL and fwd_reason is NOT NULL) or (fwd_repair_id is NOT NULL or fwd_serv_to_repair is NOT NULL))) and (branch_id='".$_SESSION['BranchId']."' or inter_branch='".$_SESSION['BranchId']."')");?>)</a></li>
                ...
                <li><a   href="<?php echo __SITE_URL;?>/serviceprovider/installations.php">Running Installation(<? echo getcountRow("SELECT * FROM installation  where installation_status  IN ('2','17','18') and (branch_id='".$_SESSION['BranchId']."' or inter_branch='".$_SESSION['BranchId']."')");?>)</a></li>

                <li><a   href="<?php echo __SITE_URL;?>/serviceprovider/installation_forward_to_repair.php">Installation Forward to Repair(<? echo getcountRow("SELECT * FROM installation  where (installation_status='11' and ((fwd_tech_rm_id is NOT NULL and fwd_reason is NOT NULL) or (fwd_repair_id is NOT NULL or fwd_install_to_repair is NOT NULL))) and (branch_id='".$_SESSION['BranchId']."' or inter_branch='".$_SESSION['BranchId']."')");?>)</a></li>
