...
?>
      <tr align="center" <? echo $rowStyle;?> >
        ...
        <td>&nbsp; 
          <?php
		  if($data[$i]['tel_voltage']<'3.5' && $data[$i]['tel_voltage']>'0.0')
...
?>
        ...
        <td><a href="service_request.php?u=<?php echo $userId;?>&c=<?php echo $Company;?>&v=<?php echo $data[$i]["veh_reg"];?>&m=pointer&i=<?php echo $data[$i]["imei"];?>&d=<?php echo $data[$i]["sys_created"];?>&n=<?php echo $data[$i]["lastcontact"];?>&Addservice=true" >Add Service</a></td>
        <td>&nbsp;<!--  <a href="#" onclick="return ConfirmDelete(<?php echo $data[$i]["id"];?>);"  >Add Comment</a> --> 
          
          <a href="addcomment-iframe.php?serviceid=<?= $data[$i]["id"]?>&height=220&width=480" class="thickbox"  >Add Comment</a></td>
