...
function deleted(row_id)
{
    ...
    $.ajax({
        type:"GET",
        url:"userInfo.php?action=clientExtensionDelete",
         data:"row_id="+row_id,
...
<div align="center">
    ...
    <a href="addclient_info.php" class="button">ADD NEW </a>
...
<?php
 ...
 {
    $WhereQuery=" where request_by='".$_SESSION['username']."' and final_status='1'";   
 }
 else if($_POST["Showrequest"]==2)
 {
    $WhereQuery=" where request_by='".$_SESSION['username']."'";
 }
 else
 { 
    $WhereQuery=" where request_by='".$_SESSION['username']."' and final_status='0'";
...
<tr align="center">
  ...
  <td><a href="addclient_info.php?rowid=<?=$assign_client[$k]['id'];?>&action=edit">Edit</a> 
        | <a href="#" onclick="return ConfirmDelete(<?php echo $assign_client[$k]["id"];?>);" >Delete</a>
