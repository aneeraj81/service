    ...
    ?>  
 	...
 	<td><?php echo $i ?></td>
       ...
       <td>&nbsp;<?php if($rs[$i]['device_status']==20){ echo "Raw Inventory" ;} if($rs[$i]['device_status']==55){ echo "Installed" ;} 
        ...
        if($rs[$i]['device_status']==69){ echo "FFC Done But Pending for Replace as New/Old" ;} if($rs[$i]['device_status']==70){ echo "Dead Device" ;}
        if($rs[$i]['device_status']==71){ echo "Replace On Repair Device" ;} if($rs[$i]['device_status']==72){ echo "Dead Device Remarks Pending" ;} 
        if($rs[$i]['device_status']==75){ echo "Branch Repair" ;} if($rs[$i]['device_status']==76){ echo "Device Against Pyment With FFC" ;} 
        if($rs[$i]['device_status']==77){ echo "Device Against Pyment Without FFC" ;} if($rs[$i]['device_status']==79){ echo "Send To Repair Centre" ;}
        ...
        if($rs[$i]['device_status']==106){ echo "Sim is Pending for Deactivation" ;} if($rs[$i]['device_status']==108){ echo "Archiev Dead List" ;}
