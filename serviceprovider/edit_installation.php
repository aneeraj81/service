...
/*echo $query1=("UPDATE installation SET  inst_name='$inst_name',inst_cur_location='$inst_cur_location',inst_date='".date("Y-m-d")."',newpending='0',status='0' ".$setqry." WHERE id='$id'");*/
    ...
    //echo "UPDATE installation_request SET installation_status='2' WHERE id='".$inst_req_id."'";
    //echo "<br>";
    //echo "UPDATE installation SET 'inst_name'='".$inst_name."', 'inst_id'='".$inst_id."', 'inst_cur_location' = '".$inst_cur_location."', 'newpending' => '0', 'status' => '0', 'billing' =>  '".$billing."', 'payment' =>  '".$payment."', 'job_type' =  '".$job_type."', 'installation_status' =>  '2'".$setqry." WHERE id='$id'";
    //die;
    ...
    $Update_installation = array('inst_name' => $inst_name, 'inst_id' => $inst_id, 'inst_cur_location' => $inst_cur_location, 'newpending' => '0', 'status' => '0', 'billing' =>  $billing,  'job_type' =>  $job_type, 'installation_status' =>  '2');
