...
if($errMSG=="")
    {
        ...
        mysql_query("UPDATE installation SET payment_status='$payment_status',amount='$amount',paymode='$paymode',reason='$reason',rtime='$rtime',close_date='".date("Y-m-d")."',inst_date='".date("Y-m-d")."',newpending='0', newstatus='0', device_type='$device_type', billing='$billing', payment='$payment',installation_made='$total_inst_made', installation_status=5, sim_change_status='$sim_change', done_required='$done_required', data_check_string='$data_check'   WHERE id='$id'",$dblink2);
        ...
        {
        mysql_query("UPDATE installation_request SET close_date='".date("Y-m-d")."', installation_made='".$close_inst_row[0]['total_row']."', installation_status=5 WHERE id='".$inst_req_id."'",$dblink2);
        }        
