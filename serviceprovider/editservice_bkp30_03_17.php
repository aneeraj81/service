					...
					if($data_count > 0)
				    {
						...
						{	
							...
							if($total_count>0)
							{
								...
								$inventory_query = mssql_query("insert into device_repair(device_id, client_name,device_imei,veh_no, device_removed_date, device_removed_branch, device_removed_problem, current_record, device_status,Remove_installer_name,veh_service_id) values('".$device_id['device_id']."','".$name."','".$rows[0]['device_imei']."','".$veh_reg."','".date('Y-m-d H:i:s')."','".$_SESSION['BranchId']."','".$reason."','1','66','".$inst_name1."','".$veh_service_id."')");
