...
<div class="table">
  <?php
	...
	$rs = select_query("SELECT * FROM services  where (service_status='11' and fwd_serv_to_repair is NOT NULL) and (branch_id='".$_SESSION['BranchId']."' or inter_branch='".$_SESSION['BranchId']."') order by id desc");
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
    ...
    ?>
      ...
      <tr align="Center"   <? if($rs[$i]['service_status']==5 or $rs[$i]['service_status']==6 )  {  ?> style="background:#CCCCCC;" <? }
		...
		?> </strong></td>
        <td  >&nbsp;<?php echo $rs[$i]['fwd_serv_to_repair'] ;?></td>
