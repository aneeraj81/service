...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
	<thead>
        ...
        <th width="7%" align="center"><font color="#0E2C3C"><b>Approve Vehicle <br/>/IP Box</b></font></th>
        <?php } else{?>
    ...
    <td><?php echo $i+1; ?></td>
		...
		<td width="10%" align="center">&nbsp;<?php $sales=select_query("select name from sales_person where id='$rs[$i][sales_person]' "); echo $sales[0]['name'];?></td> 
