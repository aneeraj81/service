    ...
    <div align="center">
     <form name="myformlisting" method="post" action="">
      <select name="Showrequest" id="Showrequest" onchange="form.submit();" >
              <option value="" <?if($_POST['Showrequest']==''){ echo 'Selected';}?>>Select</option>
            ...
            <option value="7" <?if($_POST['Showrequest']==7){ echo "Selected";}?>>All </option>
            </select>
            </form>
        </div>              
     </div>
