...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
   ...
   { 
    ?>  
     <tr align="Center">
        	<td>&nbsp;<?php echo $i ?></td>
            <td>&nbsp;<?php echo $row["old_client_name"];?></td>
            <td>&nbsp;<?php echo $row["old_veh_no"]?></td>
            <td>&nbsp;<?php echo $row["device_id"];?></td>
            <td>&nbsp;<?php echo $row["old_device_imei"]?></td>
            <td>&nbsp;<?php echo $row["new_device_imei"]?> </td>
            <td>&nbsp;<?php echo $row["replaced_date"]?></td>
            <td>&nbsp;<?php echo $row["old_itgc_id"]?></td>
            <td>&nbsp;<?php echo $row["new_itgc_id"]?></td> 
