...
<?php
 ...
 {
	   $WhereQuery=" where final_status=1 and forward_req_user='".$_SESSION["username"]."'";
 }
...
else if($query[$i]["device_type"]=='Old') {
...
<td>
<a href="#" onclick="Show_record(<?php echo $query[$i]["id"];?>,'new_device_addition','popup1'); " class="topopup">View Detail</a>
</td>
