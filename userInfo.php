...
if(isset($_GET['action']) && $_GET['action']=='sendRD')
{
    $installation_id=$_GET['RowId'];
  
    $Updateapprovestatus="update installation set installation_status='21' where id=".$installation_id;
